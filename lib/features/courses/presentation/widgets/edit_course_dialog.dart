// lib/features/courses/presentation/widgets/edit_course_dialog.dart
...
class _EditCourseDialogState extends State<EditCourseDialog> {
  ...
  void initState() {
    ...
    _durationController = TextEditingController(text: widget.course.durationMonths.toString());
    _selectedBranchId = widget.course.branchId;
    _loadBranches();
  }
